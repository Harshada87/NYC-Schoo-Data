...
public class SchoolDetailActivity extends Activity {
    private String url = "https://data.cityofnewyork.us/";//"https://data.cityofnewyork.us/";
...
initView();
    ...
    private void initView() {
       ...
       Call<List<SchoolDetailRepo>> call = client.reposForUser("734v-jeq5.json");//("734v-jeq5.json");//("fs-opensource");
